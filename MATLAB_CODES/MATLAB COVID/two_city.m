...
% exportgraphics(i,'infected_mig_0.01_0.01.eps')
% exportgraphics(i,'infected_mig_0.01_0.02.eps')
figure
%------Exposed Population----
...
% exportgraphics(r,'recovered_mig_0.01_0.02.eps')
...
% m21=0.02; %from city 1 to city 2
% m12=0.01; %from city 2 to city 1

m21=0.1; %from city 1 to city 2
